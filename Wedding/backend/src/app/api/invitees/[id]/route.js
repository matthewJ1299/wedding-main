...
export async function PUT(request, { params }) {
  try {
    ...
    const allowedFields = ['name', 'partner', 'email', 'phone', 'rsvp', 'rsvpPrimary', 'rsvpPartner', 'inviteCode', 'allowPlusOne', 'plusOneName', 'plusOneEmail', 'plusOnePhone', 'mealSelection', 'songRequest', 'messageToCouple'];
